...
export const HomeObj1 = {
  ...
  img: require('../../images/creditcard.svg'), //requires .default for V4.0 react script onwards
  primary: true,
  dark: true,
  darkText: false,
}
...
export const HomeObj2 = {
  ...
  description:
    'A peer-peer marketplace to allow crypto token exchange using AMM as our fundamental strategy, built and adapted from Uniswap V3!',
